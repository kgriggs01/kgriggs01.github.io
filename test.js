    ...
    for (let i = 0; i < jsObject.list.length; i++) {
      if (jsObject.list[i].dt_txt.includes('18:00:00')) {
        ...
        for (let j = 0; j < [i].length; j++) {
          //console.log(jsObject.list[i][key][j])
          //console.log(jsObject.list[i].dt_txt);
          //console.log(jsObject.list[i].main.temp.toFixed(0));
          //console.log(jsObject.list[i].weather[0].icon);
          ...
          //tempInfo = jsObject.list[i].main.temp;
      
          let futureTemp = 'tempInfo';
          //document.getElementById('futureTemp').textContent = tempInfo;

document.getElementById('tempInfo').textContent = jsObject.list[i].main.temp;
