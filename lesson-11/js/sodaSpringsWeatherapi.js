 const weatherURL = "https://api.openweathermap.org/data/2.5/weather?id=5678757&units=imperial&APPID=c5be23148aa1ea915f584c3fbe57e45c";
 ...
 const forecastURL = "https://api.openweathermap.org/data/2.5/forecast?id=5678757&units=imperial&APPID=c5be23148aa1ea915f584c3fbe57e45c";
    ...
    let thingsToDo = 0;
     ...
     for (let i = 0; i < towns.length; i++) {
       ...
       if (towns[i].name == 'Preston') {
        ...
        let test = towns[i].events;
        let tempInfo = 'townEvents' + thingsToDo;
        document.getElementById(tempInfo).textContent = test;
     

         thingsToDo = thingsToDo + 1;

 
         console.log(towns[i].events[thingsToDo])
